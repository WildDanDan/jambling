...
character_level = 89
net_gold_per_sale = 14_470
max_sales = (character_level * 10_000 // net_gold_per_sale) - 2
run_count = 3
...
config = {
  ...
  'coords': {
    ...
    'vendor_weapon_position': (1173, 417),
    ...
    'trade_menu_option': (1355, 337), # click trade option
